...
class StudentRepo {
  static Future<Map<String, dynamic>> signup(
    ...
    try {
      var response = await client.post(
        Uri.parse('http://192.168.1.20:5000/signup/'),
  ...
  static Future<Map<String, dynamic>> updateStudentData(
    ...
    try {
      var request = http.MultipartRequest(
        'PUT',
        Uri.parse('http://192.168.1.20:5000/updatestudentdata/'),
      );
  ...
  static Future<Map<String, dynamic>> getStudentData() async {
    ...
    try {
      var response = await client.get(
        Uri.parse('http://192.168.1.20:5000/getstudentdata/'),
  ...
  static Future<Map<String, dynamic>> login(
    ...
    try {
      var response = await client.post(
        Uri.parse('http://192.168.1.20:5000/login/'),
        body: json.encode(studentData),
        headers: {"Content-Type": "application/json"},
      );
      final data = json.decode(response.body);
